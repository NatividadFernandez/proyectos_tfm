...
const Layout = ({ children }) => {
    ...
    return (
        <>
            <Head>
                <title>Gestión Prácticas-Empresas</title>
            </Head>
            {router.pathname === '/login' || router.pathname === '/registro' ? (
                ...
                <div className="min-h-screen">
                     <svg
                        ...
                        className="absolute block w-full sm:min-h-screen md:min-h-screen lg:max-h-screen  min-h-screen back"
                    ...
                    <div className='sm:flex min-h-screen'>
                        <Sidebar />
                        <main className='sm:w-4/5 md:w-4/5 lg:w-4/5 xl:w-4/5 sm:min-h-screen p-5' > {/* sm:w-2/3 xl:w-4/5 sm:min-h-screen p-5*/}
                            <Header />
                            {children}
