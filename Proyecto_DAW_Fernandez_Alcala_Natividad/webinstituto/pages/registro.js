...
export default function Registro() {
    ...
    // Mutation para que se registren nuevos usuarios
    const [nuevoUsuario] = useMutation(REGISTRO);

    // Routing, nos redirige a la ruta que seleccionemos
                        ...
                        <div className="container mx-auto xl:px-32 text-gray-800">
                            <div className="grid lg:grid-cols-2 gap-12 flex items-center">
                                ...
                                <div className="mb-12 lg:mb-0 relative">
                                    ...
                                    <div className="block rounded-lg shadow-lg px-6 py-12 md:px-12" style={{ backgroundColor: "hsla(0, 0%, 100%, 0.9)", backdropFilter: "saturate(200%) blur(25px)" }}>
