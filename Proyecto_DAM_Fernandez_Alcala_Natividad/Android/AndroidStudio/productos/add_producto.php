...
// Consulta que devuelve la voladura con x fecha
...
if(comprobarNumero($arena_06) && comprobarNumero($grava_612) && comprobarNumero($grava_1220) &&
    ...
    $consulta = $bd->query("INSERT INTO productos (arena_06,grava_612,grava_1220,grava_2023,rechazo,zahorra,escollera,mamposteria,voladura,voladura_fecha,id_empleado) VALUES ('$arena_06','$grava_612','$grava_1220','$grava_2023','$rechazo','$zahorra','$escollera','$mamposteria','$voladura_id','$fecha_voladura','$id_empleado')"); 
    ...
    if(!$consulta){
        ...
        $consultaS = $bd->query("INSERT INTO stock_productos (arena_06,grava_612,grava_1220,grava_2023,rechazo,zahorra,escollera,mamposteria,voladura,voladura_fecha,id_empleado) VALUES ('$arena_06','$grava_612','$grava_1220','$grava_2023','$rechazo','$zahorra','$escollera','$mamposteria','$voladura_id','$fecha_voladura','$id_empleado')"); 

        if(!$consultaS){
            printf("Error: %s\n", $bd->error); 
            exit();
        }// Insertamos a la vez el stock del producto
    }                            
