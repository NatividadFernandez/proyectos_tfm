...
if(comprobarNumero($gasoleo) && comprobarNumero($aceite_motor) && comprobarNumero($aceite_hidraulico) &&
    ...
    // Actualizamos el stock de consumo
    $consulta = $bd->query("UPDATE stock_consumos SET gasoleo = '$gasoleo', aceite_motor = '$aceite_motor', aceite_hidraulico = '$aceite_hidraulico',
    aceite_transmisiones = '$aceite_transmisiones', valvulina = '$valvulina', grasas = '$grasas',
    fecha_consumo = '$fecha_consumo', id_empleado = '$id_empleado' WHERE id='$id'");    
