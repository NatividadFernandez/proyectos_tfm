...
<div id="containerLogin">
    ...
    <div class="panel-container">
      <div class="panel">
        <h1 class="panel_heading">{{'Iniciar sesión'}}</h1>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            @if (Route::has('password.request'))
                <p class="consentsPass">
                    <a href="{{ route('password.request') }}">¿Has olvidado tu contraseña?</a>
                </p>
            @endif

            <p class="consents">
                Al hacer clic en Iniciar Sesión, acepto que he leído y aceptado 
...
{{-- <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><div class="title">{{ __('Login') }}</div></div>
